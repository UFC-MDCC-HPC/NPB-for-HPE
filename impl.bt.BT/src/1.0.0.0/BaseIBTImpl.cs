...
private IMultiPartition<IInstance_BT<CLASS>, CLASS> process = null;

protected IMultiPartition<IInstance_BT<CLASS>, CLASS> Process {
	get {
		if (this.process == null)
			this.process = (IMultiPartition<IInstance_BT<CLASS>, CLASS>) Services.getPort("data_partition");
		return this.process;
	}
}
