...
namespace impl.sp.solve.ZSolver { 
	...
	{		
		...
		{		
		    ...
		    {
				Console.WriteLine("{0}: BEGIN LOOP FORWARD-Z {1}", this.Rank, k);
				...
				Forward.go();
				Forward.advance();
				Console.WriteLine("{0}: END LOOP FORWARD-Z {1}", this.Rank, k++);
		    ...
		    {				
				Console.WriteLine("{0}: BEGIN LOOP BACKWARD-Z {1}", this.Rank, k);
				...
				Backward.go();
		        Backward.advance ();								
				Console.WriteLine("{0}: END LOOP BACKWARD-Z {1}", this.Rank, k++);
		    }
	        //---------------------------------------------------------------------
